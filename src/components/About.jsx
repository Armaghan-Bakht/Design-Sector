...
import portrait from "../assets/AI/about_portrait_1775586685115.png";
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 lg:grid-cols-2">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4 text-sm font-light leading-relaxed tracking-wide text-slate-400">
            <p>
              At Design Sector, we believe design isn’t just about looking good
              it’s about getting results.{" "}
            </p>
            <p>
              From scroll-stopping social media creatives to high-converting
              Amazon listings, we focus on what actually matters: helping your
              brand stand out and sell more.
            </p>
            <p>
              With 6+ years of experience, we know what works and what doesn’t.
            </p>
          </div>
